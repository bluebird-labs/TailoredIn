...
- **Tone:** By default, derive the candidate's voice, tone, and writing style from the About section provided and mirror their personality and communication style. This is the default only - if the user instructions ask for a different tone, voice, or style, follow the user instructions instead.
