...
import { QueryOpts, RefOrEntity } from '../../helpers';
import { Job } from './Job';
...
import { findTopScoredJobs, IFindTopScoredJobsParams, IFindTopScoredJobsResult } from './sql/findTopScoredJobs.sql';
...
import { IScoreJobByIdParams, scoreJobById } from './sql/scoreJobById.sql';
  ...
  public async findByCompanyNameLike<Hint extends string & 'company' = 'company'>(
    ...
    return this.getEm(opts)
      ...
      .find(
        ...
        {
          ...opts,
          populate: Array.from(new Set(['company', ...(opts.populate || [])]))
        }
      );
  }
