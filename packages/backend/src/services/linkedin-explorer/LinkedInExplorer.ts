...
} from './LinkedInSearchJobsCommand';
import Path from 'node:path';
import { ROOT_DIR } from '../../../ROOT_DIR';
...
export const DEFAULT_AUTH_FILE = Path.resolve(ROOT_DIR, 'playwright/.auth/linkedin.json');
...
export class LinkedInExplorer {
  ...
  public constructor(@inject(DI.LinkedInExplorerConfig) config: LinkedInExplorerConfig) {
    this.config = config;
