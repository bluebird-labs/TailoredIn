...
import { LinkedInUrls } from './linkedin-explorer/LinkedInExplorer';
import { LinkedInSearchJobsCommandResult } from './linkedin-explorer/LinkedInSearchJobsCommand';
import { MikroORM } from '@mikro-orm/postgresql';
import { Job } from '../orm/entities/jobs/Job';
import { Company } from '../orm/entities/companies/Company';
import { TransientJob } from '../orm/entities/jobs/TransientJob';
import { TransientCompany } from '../orm/entities/companies/TransientCompany';
import { inject, injectable } from 'inversify';
import { DI } from '../di/DI';
import { JobStatus } from '../orm/entities/jobs/JobStatus';
import { QueryOpts } from '../orm/helpers';

@injectable()
export class JobSearchHandler {
  public constructor(@inject(DI.Orm) private readonly orm: MikroORM) {}
