...
import { LinkedInExplorer } from '../services/linkedin-explorer/LinkedInExplorer';
import { IJobElector } from '../services/job-elector';
import { JobSearchHandler } from '../services/JobSearchHandler';
import { JobStatus } from '../orm/entities/jobs/JobStatus';
import { MikroORM, RequestContext } from '@mikro-orm/postgresql';
import { LinkedInSearchJobsCommandParams } from '../services/linkedin-explorer/LinkedInSearchJobsCommand';
import config from '../../config';
import { TimeUtil } from '../utils/TimeUtil';
import { milliseconds } from 'date-fns';
import { omit, pick } from 'lodash';
import { InspectUtil } from '../utils/InspectUtil';

const LOG_PREFIX = 'JobFinder';
const orm = container.get<MikroORM>(DI.Orm);
const jobSearchHandler = container.get<JobSearchHandler>(DI.JobSearchHandler);
const jobElector = container.get<IJobElector>(DI.JobElector);
const linkedinExplorer = container.get<LinkedInExplorer>(DI.LinkedInExplorer);
