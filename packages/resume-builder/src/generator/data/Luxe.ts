...
export const Luxe = CompanyConfig.create({
  ...
  bullets: [
    ...
    // Leadership
    'Played a pivotal role in agile development processes, including sprint planning, estimation, and retrospectives, establishing transparency and accountability for the engineering organization'
  ]
});
