...
import { Archetype }          from '../src/generator/data/types';
import { generateCV }         from '../src/generator/generateCV';
import { TypstFileGenerator } from '../src/generator/TypstFileGenerator';
...
Yargs(hideBin(process.argv))
  .command('gen', 'Generate a CV', (yargs) => {
    ...
    const outputDir = Path.resolve(__dirname, '..', 'Resumes', (args.company_name as string).toLowerCase());
