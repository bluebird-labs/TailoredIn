...
import type { SetArchetypeTagProfile } from '@tailoredin/application';
import { DI } from '@tailoredin/infrastructure';
import { Elysia, t } from 'elysia';

@injectable()
export class SetArchetypeTagProfileRoute {
  public constructor(private readonly setTagProfile: SetArchetypeTagProfile = inject(DI.Archetype.SetTagProfile)) {}
