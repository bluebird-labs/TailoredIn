...
import { JobPosting, JobStatus, Company } from '@tailoredin/domain-job';
...
export class IngestScrapedJob {
  ...
  constructor(
    ...
    private readonly companyRepository = inject(ApplicationJobDI.CompanyRepository),
    private readonly jobElector = inject(ApplicationJobDI.JobElector)
  ) {}
