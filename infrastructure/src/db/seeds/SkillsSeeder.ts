...
const skills = new Map<string, { affinity: SkillAffinity; variants: string[] }>([
  ...
  ['Javascript', { affinity: SkillAffinity.AVOID, variants: ['JS', 'js', 'JavaScript'] }],
  ...
  ['Swift', { affinity: SkillAffinity.INTEREST, variants: [] }],
  ...
  ['Memcached', { affinity: SkillAffinity.EXPERT, variants: [] }],
  ...
  ['S3', { affinity: SkillAffinity.EXPERT, variants: [] }],
  ['S3 Glacier', { affinity: SkillAffinity.EXPERT, variants: [] }],
  ...
  ['ElastiCache', { affinity: SkillAffinity.EXPERT, variants: ['Elasticache'] }],
  ...
  ['Backend', { affinity: SkillAffinity.EXPERT, variants: [] }],
