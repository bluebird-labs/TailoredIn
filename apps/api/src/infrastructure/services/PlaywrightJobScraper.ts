...
import type { JobScraper, ScrapeResultCallback } from '@tailoredin/application-job';
import type { JobSearchConfigDto } from '@tailoredin/application-job';
import { LinkedInSearchJobsCommand } from '@tailoredin/linkedin/src/LinkedInSearchJobsCommand.js';
import { LinkedInUrls } from '@tailoredin/linkedin/src/LinkedInUrls.js';
import { DEFAULT_AUTH_FILE as AUTH_FILE } from '@tailoredin/linkedin/src/LinkedInExplorer.js';
