...
import { Skill as DomainSkill, SkillId, SkillAffinity, type SkillCreateProps } from '@tailoredin/domain-job';
import type { SkillRepository, SkillRefreshOutput } from '@tailoredin/application-job';
import type { MikroORM } from '@mikro-orm/postgresql';
import { Skill as OrmSkill, type SkillCreateProps as OrmSkillCreateProps } from '../db/entities/skills/Skill.js';
import { SkillOrmRepository } from '../db/entities/skills/SkillOrmRepository.js';
